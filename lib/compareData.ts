...
export const compareData: Record<string, CompareData> = {
  ...
  'clay': {
    ...
    seoDescription: 'Clay enriches lead data and automates outreach sequences. Pulsar reaches leads over WhatsApp and email, qualifies them in conversation (including AI voice calls), and books demos. Full comparison.',
  ...
  'instantly-ai': {
    ...
    seoDescription: 'Instantly.ai sends bulk cold email campaigns at scale. Pulsar runs multi-channel follow-up across WhatsApp, SMS and email, plus AI voice calls. Full comparison for B2B founders.',
