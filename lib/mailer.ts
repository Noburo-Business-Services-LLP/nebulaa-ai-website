...
<style>
  ...
  .logo { color: #F5B800; font-size: 20px; font-weight: 800; letter-spacing: -0.5px; text-decoration: none; }
  ...
  .content h2 { color: #F5B800; font-size: 18px; font-weight: 700; margin: 28px 0 12px; }
  .content p { margin: 0 0 16px; }
  .content strong { color: #FFFFFF; }
  .content a { color: #F5B800; }
  .content ul { padding-left: 20px; margin: 0 0 16px; }
  .content li { margin-bottom: 8px; }
  .cta-block { background: #1A1815; border: 1px solid #F5B800/20; border-radius: 16px; padding: 28px; margin: 32px 0; text-align: center; }
  .cta-btn { display: inline-block; background: #F5B800; color: #0A0A0A; font-weight: 800; font-size: 15px; padding: 14px 32px; border-radius: 100px; text-decoration: none; }
  ...
  .tag { display: inline-block; background: #F5B800/15; color: #F5B800; font-size: 11px; font-weight: 700; padding: 3px 10px; border-radius: 100px; margin-bottom: 16px; text-transform: uppercase; letter-spacing: 1px; }
</style>
</head>
<body>
<div class="wrapper">
