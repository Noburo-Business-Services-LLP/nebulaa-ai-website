"use strict";(()=>{var e={};e.id=1622,e.ids=[1622],e.modules={21841:e=>{e.exports=require("@aws-sdk/client-s3")},20399:e=>{e.exports=require("next/dist/compiled/next-server/app-page.runtime.prod.js")},30517:e=>{e.exports=require("next/dist/compiled/next-server/app-route.runtime.prod.js")},61282:e=>{e.exports=require("child_process")},84770:e=>{e.exports=require("crypto")},80665:e=>{e.exports=require("dns")},17702:e=>{e.exports=require("events")},92048:e=>{e.exports=require("fs")},32615:e=>{e.exports=require("http")},35240:e=>{e.exports=require("https")},98216:e=>{e.exports=require("net")},19801:e=>{e.exports=require("os")},55315:e=>{e.exports=require("path")},76162:e=>{e.exports=require("stream")},82452:e=>{e.exports=require("tls")},17360:e=>{e.exports=require("url")},21764:e=>{e.exports=require("util")},71568:e=>{e.exports=require("zlib")},40172:(e,t,r)=>{r.r(t),r.d(t,{originalPathname:()=>g,patchFetch:()=>h,requestAsyncStorage:()=>u,routeModule:()=>c,serverHooks:()=>x,staticGenerationAsyncStorage:()=>d});var n={};r.r(n),r.d(n,{POST:()=>l});var a=r(49303),o=r(88716),s=r(60670),i=r(87070),p=r(6910);async function l(e){let{name:t,email:r,source:n}=await e.json();if(!r||!/\S+@\S+\.\S+/.test(r))return i.NextResponse.json({error:"Valid email required"},{status:400});let a=await (0,p.W6)();if(a.some(e=>e.email.toLowerCase()===r.toLowerCase()))return i.NextResponse.json({success:!0,message:"already_subscribed"});let o={id:Date.now().toString(),name:t||r.split("@")[0],email:r,source:n||"Newsletter Signup",date:new Date().toISOString().split("T")[0],tags:["newsletter"]},s=await (0,p.L1)([...a,o]),l=await (0,p.p3)(o,s);return s||l?i.NextResponse.json({success:!0,message:"subscribed"}):i.NextResponse.json({error:"Could not record signup. Please email hello@nebulaa.ai."},{status:500})}let c=new a.AppRouteRouteModule({definition:{kind:o.x.APP_ROUTE,page:"/api/newsletter-signup/route",pathname:"/api/newsletter-signup",filename:"route",bundlePath:"app/api/newsletter-signup/route"},resolvedPagePath:"/Users/dineshkannaa/Documents/0 CONTENT/Claude Agents/nebulaa-ai-website/app/api/newsletter-signup/route.ts",nextConfigOutput:"standalone",userland:n}),{requestAsyncStorage:u,staticGenerationAsyncStorage:d,serverHooks:x}=c,g="/api/newsletter-signup/route";function h(){return(0,s.patchFetch)({serverHooks:x,staticGenerationAsyncStorage:d})}},6910:(e,t,r)=>{r.d(t,{L1:()=>i,W6:()=>s,p3:()=>p});var n=r(58741),a=r(31528);let o="leads.json";async function s(){return(0,n.zr)(o,[])}async function i(e){return(0,n.Nn)(o,e)}async function p(e,t){let r=process.env.LEADS_NOTIFY_TO||"hello@nebulaa.ai";if(!process.env.SMTP_USER||!process.env.SMTP_PASS)return!1;try{let o=(0,a.q)();return await o.sendMail({from:process.env.SMTP_FROM||process.env.SMTP_USER,to:r,subject:`New lead — ${e.email}`,text:[`Email:  ${e.email}`,`Name:   ${e.name}`,`Source: ${e.source}`,`Date:   ${e.date}`,"",t?`Also stored in ${(0,n.Q1)()?"S3":"data/leads.json"}.`:"NOT stored — this email is the only record. Check the lead store."].join("\n")}),!0}catch{return!1}}},31528:(e,t,r)=>{r.d(t,{q:()=>a,u:()=>o});var n=r(55245);function a(){return n.createTransport({host:process.env.SMTP_HOST||"smtp.gmail.com",port:parseInt(process.env.SMTP_PORT||"587"),secure:465===parseInt(process.env.SMTP_PORT||"587"),auth:{user:process.env.SMTP_USER,pass:process.env.SMTP_PASS}})}function o(e,t){return`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8"/>
...
</html>`}},58741:(e,t,r)=>{r.d(t,{KD:()=>g,Nn:()=>x,Q1:()=>h,zr:()=>d});var n=r(92048),a=r.n(n),o=r(55315),s=r.n(o);let i=()=>process.env.DATA_BUCKET,p=()=>process.env.AWS_REGION||"ap-south-1",l=e=>s().join(process.cwd(),"data",e),c=null;async function u(){if(!c){let{S3Client:e}=await Promise.resolve().then(r.t.bind(r,21841,23));c=new e({region:p()})}return c}async function d(e,t){let n=i();if(!n)try{return JSON.parse(a().readFileSync(l(e),"utf8"))}catch{return t}try{let{GetObjectCommand:a}=await Promise.resolve().then(r.t.bind(r,21841,23)),o=await (await u()).send(new a({Bucket:n,Key:e})),s=await o.Body?.transformToString();return s?JSON.parse(s):t}catch{return t}}async function x(e,t){let n=i(),o=JSON.stringify(t,null,2);if(!n)try{return a().mkdirSync(s().dirname(l(e)),{recursive:!0}),a().writeFileSync(l(e),o),!0}catch{return!1}try{let{PutObjectCommand:t}=await Promise.resolve().then(r.t.bind(r,21841,23));return await (await u()).send(new t({Bucket:n,Key:e,Body:o,ContentType:"application/json"})),!0}catch{return!1}}async function g(e,t=1e3){let n=i();if(!n)try{let r=l(e);return a().readdirSync(r).map(t=>`${e}/${t}`).slice(0,t)}catch{return[]}try{let a;let{ListObjectsV2Command:o}=await Promise.resolve().then(r.t.bind(r,21841,23)),s=[];do{let t=await (await u()).send(new o({Bucket:n,Prefix:e,ContinuationToken:a}));for(let e of t.Contents||[])e.Key&&s.push(e.Key);a=t.IsTruncated?t.NextContinuationToken:void 0}while(a&&s.length<t);return s.slice(0,t)}catch{return[]}}let h=()=>!!i()}};var t=require("../../../webpack-runtime.js");t.C(e);var r=e=>t(t.s=e),n=t.X(0,[8948,5972,5245],()=>r(40172));module.exports=n})();