      ...
      >
        ...
        <div>
          ...
          <motion.h1
            ...
            className="font-heading text-[40px] md:text-[52px] lg:text-[74px] leading-[1.06] lg:leading-[1.04] tracking-[-0.02em] font-medium text-[#F5F4F1] mb-[30px]"
          ...
          <motion.div variants={fadeUpVariant} className="flex flex-col sm:flex-row sm:items-center gap-3.5 mb-[26px]">
            <a
              href="#pricing"
              className="bg-brand-gold text-[#1A1208] text-[15px] font-semibold px-[30px] py-4 sm:py-[15px] rounded-full shadow-[0_6px_26px_rgba(245,166,35,0.24)] hover:brightness-105 transition text-center"
            >
              Start free — no card
            </a>
            <a
              href="/services/enterprise"
              className="border border-white/[0.12] text-white/75 text-[15px] font-medium px-7 py-4 sm:py-[15px] rounded-full hover:border-white/25 transition text-center"
            >
