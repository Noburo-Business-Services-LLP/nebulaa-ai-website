...
export const compareData: Record<string, CompareData> = {
  'buffer': {
    ...
    seoTitle: 'Nebulaa vs Buffer: Agents vs Scheduling',
    ...
    nebulaaStrengths: ['Writes content using your brand voice', 'Tracks competitor activity', 'WhatsApp + email follow-up sequences', 'Calls and qualifies leads automatically'],
  ...
  'jasper-ai': {
    ...
    nebulaaStrengths: ['Content published automatically (no prompting needed)', 'Runs 24/7 without input', 'Purpose-built for founder-led GTM', 'Calls leads without human involvement'],
  ...
  'clay': {
    ...
    subheadline: 'Clay enriches and sequences your leads. Pulsar messages them on WhatsApp, qualifies them in conversation, and hands you only the warm ones.',
    seoTitle: 'Nebulaa vs Clay: Lead Gen Comparison',
    seoDescription: 'Clay enriches lead data and automates outreach. Pulsar reaches leads over WhatsApp and email, qualifies them in conversation, and books demos.',
    ...
    verdict: 'Clay is powerful for technical GTM teams who want to enrich data and build complex outreach logic. Nebulaa is built for founders who want leads qualified in conversation without building complex workflows.',
    bestFor: {
      nebulaa: 'Founders who want leads qualified in conversation, hands-free — WhatsApp first, calls where they fit',
  ...
  'hootsuite': {
    ...
    seoDescription: 'Hootsuite manages social media. Nebulaa is an AI agent that generates, schedules and publishes content — and follows up with leads.',
    ...
    tableRows: [
      ...
      { feature: 'Price (entry)', nebulaa: '₹15,000/mo', competitor: '$99/mo' },
    ],
  ...
  'instantly-ai': {
    ...
    subheadline: 'Instantly sends bulk cold emails. Pulsar follows up on WhatsApp, SMS and email — and calls when it matters.',
    seoTitle: 'Nebulaa vs Instantly.ai: Outreach Compared',
    seoDescription: 'Instantly.ai sends bulk cold email at scale. Pulsar runs multi-channel follow-up across WhatsApp, SMS, email, plus AI voice calls.',
