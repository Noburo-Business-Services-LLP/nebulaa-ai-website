...
export const servicePages: ServicePage[] = [
  ...
  },
  {
    ...
    subheadline:
      'A creator with eight thousand engaged followers in your city is usually worth more than a national name with two million spread across the country. We source regional creators, brief them, review what they produce and measure what it did.',
    howItWorks: [
